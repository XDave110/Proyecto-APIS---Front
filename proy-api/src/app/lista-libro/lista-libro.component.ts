...
export class ListaLibroComponent implements OnInit {
  ...
  constructor() {
    this.libros = [
      new Libro("123", "Harry Potter", "Andrei", "Este es un libro blabla", 30, "https://m.guiadelocio.com/var/guiadelocio.com/storage/images/cine/archivo-peliculas/harry-potter-y-la-piedra-filosofal/39102729-37-esl-ES/harry-potter-y-la-piedra-filosofal.jpg", ["ciencia", "terror", "aventura"]), 
